...
class PetFriends:
    ...
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """Этот метод позволяет добавить информацию о новом домашнем животном и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленной информации нового питомца"""
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фото питомца и возвращает статус
                запроса на сервер и результат в формате JSON с данными добавленного питомца"""
